<?php
   ...
   /* $con = mysqli_connect("localhost","root","","ecommerce");
    ...
    function get_pro_by_cat_id($con){
        if(isset($_GET['cat'])){
            $cat_id = $_GET['cat'];
            ...
            if($count_cats == 0){
                echo "<h2 style='padding:20px;'>No books where found in this category!</h2>";
            }
    ...
    function get_pro_by_brand_id($con){
        if(isset($_GET['brand'])){
            $brand_id = $_GET['brand'];
