    ...
    <div class="form_box">
        <form action="" method="post" enctype="multipart/form-data">
            <table align="center" width="100%">
                ...
                <tr>
                    <td valign="top"><b>Book's Image</b></td>
                    <td>
                    <input type="file" name="product_image"/>
                    <div class="edit_image">
                        <img src="product_images/<?php echo $fetch_edit['product_image']; ?>" width="100" height="100" />
                    </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <a class="line-dark d-block text-center" href="product_files/<?php echo $fetch_edit['product_file']; ?>"><?php echo $fetch_edit['product_file']; ?></a>
                    </td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td colspan="7"><input type="submit" name="edit_product" value="Edit"/></td>
                </tr>
...
<?php
    if(isset($_POST['edit_product'])){
        ...
        if(!empty($_FILES['product_image']['name']) && ($_FILES['product_file']['tmp_name'])){

        if(move_uploaded_file($product_image_tmp,"product_images/$product_image") &&  move_uploaded_file($product_file_tmp,"product_files/$product_file")){
         
        $update_product = mysqli_query($con,"update products set product_cat='$product_cat',product_brand='$product_brand',product_title='$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$product_image',product_keywords='$product_keywords',product_file='$product_file',date='$date' where product_id='$_GET[product_id]'");
        ...
        if($update_product){
            ...
            echo "<script>alert('Product was update successfully!')</script>";
