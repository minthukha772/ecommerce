    ...
    <form method="post" action="" enctype="multipart/form-data">
        <table align="left" width="70%">
            ...
            <tr>
                ...
                <td colspan="3"><input type="password" name="password" required id="password_confirm1" placeholder="Password"/></td>
            </tr>
...
<?php
    ...
    if(isset($_POST['register'])){
        ...
        if(!empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['confirm_password']) && !empty($_POST['name'])){
            ...
            if($email_count > 0){
                echo "<script>alert('Sorry, your email $email address already exists')</script>";
            }
