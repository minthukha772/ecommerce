    ...
    <form method="post" action="" enctype="multipart/form-data">
        <table align="left" width="70%">
            ...
            <tr>
                ...
                <td colspan="3"><input type="password" name="current_password"  placeholder="Current Password"/></td>
            </tr>

            <tr>
                <td width="15%"><b>New Password:</b></td>
                <td colspan="3"><input type="password" id="password_confirm1" name="new_password" required placeholder="New Password"/>
    ...
    if(isset($_POST['change_password'])){
            ...
            if(mysqli_num_rows($select_password) == 0){
                ...
                if($update){
                    ...
                    echo "<script>window.open(window.location.href,'_href')</script>";
                }else{
